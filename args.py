...
parser.add_argument('--model_variant', type=str, default='multiscale',
                    help='which decoder head to use: baseline or multiscale')
parser.add_argument('--text_encoder_type', type=str, default='transformer',
                    help='text encoder type: transformer or kan')
parser.add_argument('--text_pose_encoder_type', type=str, default='kan',
                    help='joint text-pose encoder type: transformer or kan')
parser.add_argument('--pose_projection_type', type=str, default='linear',
                    help='pose projection type: linear, mlp, or kan')
parser.add_argument('--kan_hidden_dim', type=int, default=0,
                    help='hidden size used inside KAN blocks. 0 means use hidden_dim // 2')
